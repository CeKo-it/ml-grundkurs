...
# %% [markdown] lang="de" tags=["subslide"] slideshow={"slide_type": "subslide"}
#
# ## Mini-Workshop 2: Palindrome-Checker
#
# Schreiben Sie eine Funktion `is_palindrome`, die einen String als Argument
# nimmt und `True` zurückgibt, wenn der String ein Palindrom ist, und `False`
# sonst.
#
